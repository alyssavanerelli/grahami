...
#SBATCH --job-name=maker_gff2                           # job name for listing in queue
...
awk '{ if ($2 == "est2genome") print $0 }' Agra_rnd2.all.maker.noseq.gff > Agra_rnd2.all.maker.est2genome.gff
# protein alignments
awk '{ if ($2 == "protein2genome") print $0 }' Agra_rnd2.all.maker.noseq.gff > Agra_rnd2.all.maker.protein2genome.gff
# repeat alignments
awk '{ if ($2 ~ "repeat") print $0 }' Agra_rnd2.all.maker.noseq.gff > Agra_rnd2.all.maker.repeats.gff
