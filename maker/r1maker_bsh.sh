...
rename 's/genome/AnoGra_rnd1.zff.length50_aed0.25/g'  *
# gather some stats and validate
singularity exec ${MAKER_IMAGE} fathom AnoGra_rnd1.zff.length50_aed0.25.ann AnoGra_rnd1.zff.length50_aed0.25.dna -gene-stats > gene-stats.log 2>&1
singularity exec ${MAKER_IMAGE} fathom AnoGra_rnd1.zff.length50_aed0.25.ann AnoGra_rnd1.zff.length50_aed0.25.dna -validate > validate.log 2>&1
# collect the training sequences and annotations, plus 1000 surrounding bp for training
singularity exec ${MAKER_IMAGE} fathom AnoGra_rnd1.zff.length50_aed0.25.ann AnoGra_rnd1.zff.length50_aed0.25.dna -categorize 1000 > categorize.log 2>&1
...
# assembly the HMM
hmm-assembler.pl AnoGra_rnd1.zff.length50_aed0.25 params > AnoGra_rnd1.zff.length50_aed0.25.hmm

awk -v OFS="\t" '{ if ($3 == "mRNA") print $1, $4, $5 }' ../../AnoGra_rnd1.all.maker.noseq.gff |   awk -v OFS="\t" '{ if ($2 < 1000) print $1, "0", $3+1000; else prin$
