...
busco -i /projects/f_geneva_1/alyssa/grahami/annotation/AnoGra1.1.maker.output/snap/braker/AnoGra_rnd1.all.maker.transcripts1000.fasta \
-f -o AnoGra_rnd1_aug --offline -l vertebrata_odb10 -m genome -c 30 --augustus --augustus_species human --long \
