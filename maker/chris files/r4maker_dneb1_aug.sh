...
#SBATCH --job-name=maker_dneb1_aug4
#SBATCH --mem=128000
#SBATCH -n 16
#SBATCH -N 1
...
busco -i /scratch/cjs374/maker/pilon_dneb1_cmp3.maker.output/snap/braker/dneb1_rnd4.all.maker.transcripts1000.fasta \
-f -o dneb1_rnd4_aug -l diptera_odb10 -m genome -c 30 --augustus --augustus_species Dnebulosa --long \
