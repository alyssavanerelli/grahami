...
#SBATCH --job-name=maker_dneb1_aug1-trans
#SBATCH --mem=128000
#SBATCH -n 16
#SBATCH -N 1
...
busco -i /scratch/cjs374/maker/maker_runs/pilon_dneb1_cmp3.maker.output.rnd1/pilon_dneb1_cmp3.all.maker.transcripts.fasta \
-o dneb1_annotation_eval1_1 -l diptera_odb10 -m transcriptome -c 8 --augustus_species Dnebulosa \
