...
#SBATCH --output=/projects/f_geneva_1/alyssa/sagrei/add_replace/slurmout/slurm-%j-%x.out
#SBATCH --mem=50G
#SBATCH -n 10
#SBATCH -N 1
...
READ=$4
CORE=$5
OUTDIR="/projects/f_geneva_1/alyssa/sagrei/add_replace"
BAM_DIR="/projects/f_geneva_1/alyssa/sagrei/bam"
