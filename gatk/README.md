...
## Haplotype Caller
- **ALL SITES MODE**
  - `-ERC BP_RESOLUTION` and `--output-mode EMIT_ALL_CONFIDENT_SITES`
...
## Combine gCVFs
- In this step, we will be combining the separate vcf files that we got for our scaffolds

1. Create a list file containing the names of the files to be combined
- This file should contain the names of the files to be combined along with the full path to the files

```
ls -1 /projects/f_geneva_1/alyssa/grahami/gatk/haplotype_caller/* > combine.list 
```

2. Run CombineGVCFs

[combine_gvcf.sh](https://github.com/alyssavanerelli/grahami/blob/main/gatk/combine_gvcf.sh)

---

## Genotype gCVFs
- Perform joint genotyping on one or more samples
- We will need to do this in **all sites mode**
  - `-all-sites TRUE`

[genotype_gvcf.sh](https://github.com/alyssavanerelli/grahami/blob/main/gatk/genotype_gvcf.sh)
...
[select_variants.sh](https://github.com/alyssavanerelli/grahami/blob/main/gatk/select_variants.sh)
...
[variant_table.sh](https://github.com/alyssavanerelli/grahami/blob/main/gatk/variant_table.sh)

Now we will run this [**R code**](https://github.com/alyssavanerelli/grahami/blob/main/gatk/Variant_Table.R) to determine what value we should filter each parameter on.
...
[vcftools_table.sh](https://github.com/alyssavanerelli/grahami/blob/main/gatk/vcftools_table.sh)
...
[vcftools_filter.sh](https://github.com/alyssavanerelli/grahami/blob/main/gatk/vcftools_filter.sh)
...
[invariant_filter_vcftools.sh](https://github.com/alyssavanerelli/grahami/blob/main/gatk/invariant_filter_vcftools.sh)
...
[combine_allsites.sh](https://github.com/alyssavanerelli/grahami/blob/main/gatk/combine_allsites.sh)
