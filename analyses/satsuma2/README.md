...
4. Run Satsuma
  ...
  - To run SatsumaSynteny2, you need to submit a job script with the commands below
  - SatsumaSynteny2 will then use the `satsuma_run.sh` file created above to submit subsequent slurm jobs
